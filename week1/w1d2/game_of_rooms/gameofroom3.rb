...
east_temple = Location.new([2,1], "You are in the east of a temple")
south_temple = Location.new([1,0], "You are in the sauth of a temple")
west_temple = Location.new([0,1], "You are in the west of a temple")
